...
void checkpoint( FILE *fout,inputList in,spec *SP,particleMPC *pSRD,cell ***CL,int MDmode,bc *WALL,outputFlagsList outFlag,int runtime,int warmtime,double AVVEL,double AVS,double avDIR[_3D],double S4,double stdN,double KBTNOW,double AVV[_3D],double AVNOW[_3D],kinTheory theory ) {
	/*
	...
	fprintf( fout,"%d %d %d %d %d\n",in.RFRAME,in.zeroNetMom,in.TSTECH,in.RTECH,in.LC );
	...
	fprintf( fout,"%d %d %lf\n",in.warmupSteps,in.simSteps,in.dt );		//Warmup time iterations, total time (or number of loops) and time step
	...
	fprintf( fout,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n", theory.MFP, theory.VISC, theory.THERMD, theory.SDIFF, theory.sumM, AVVEL, AVS, avDIR[0], avDIR[1], avDIR[2], S4, stdN, nDNST, mDNST );
	fprintf( fout,"%lf %lf %lf %lf %lf %lf\n",AVV[0], AVV[1], AVV[2], AVNOW[0], AVNOW[1], AVNOW[2] );

	//Output variables
	fprintf( fout,"%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d\n",DBUG,outFlag.TRAJOUT,outFlag.printSP,outFlag.COAROUT,outFlag.FLOWOUT,outFlag.AVVELOUT,outFlag.ORDEROUT,outFlag.QTENSOUT,outFlag.QKOUT,outFlag.AVSOUT,outFlag.SOLOUT,outFlag.ENOUT,outFlag.ENFIELDOUT,outFlag.ENSTROPHYOUT,outFlag.DENSOUT,outFlag.CVVOUT,outFlag.CNNOUT,outFlag.CWWOUT,outFlag.CDDOUT,outFlag.CSSOUT,outFlag.CPPOUT,outFlag.BINDER,outFlag.BINDERBIN,outFlag.SYNOUT,outFlag.CHCKPNT );
	...
	fprintf( fout,"%d\n",NBC );
	for( i=0; i<NBC; i++ ) {
		fprintf( fout,"%d %d %lf %lf %lf %lf %lf %lf %lf\n",WALL[i].COLL_TYPE, WALL[i].PHANTOM, WALL[i].E, WALL[i].Q[0], WALL[i].Q[1], WALL[i].Q[2], WALL[i].V[0], WALL[i].V[1], WALL[i].V[2] );
		fprintf( fout,"%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n", WALL[i].L[0], WALL[i].L[1], WALL[i].L[2], WALL[i].G[0], WALL[i].G[1], WALL[i].G[2], WALL[i].A[0], WALL[i].A[1], WALL[i].A[2],WALL[i].P[0],WALL[i].P[1],WALL[i].P[2],WALL[i].P[3], WALL[i].R );
		...
		fprintf( fout,"%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n", WALL[i].PLANAR, WALL[i].W, WALL[i].VOL, WALL[i].Q_old[0], WALL[i].Q_old[1], WALL[i].Q_old[2], WALL[i].I[0][0], WALL[i].I[0][1], WALL[i].I[0][2], WALL[i].I[1][0], WALL[i].I[1][1], WALL[i].I[1][2], WALL[i].I[2][0], WALL[i].I[2][1], WALL[i].I[2][2] );
	}
