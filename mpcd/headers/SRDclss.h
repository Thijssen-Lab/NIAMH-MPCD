...
typedef struct cell {
	...
	double SWFLOW[4];			///< Centre of mass velocity of the cell in the first swimmer's reference frame, averaged over SWFLOWOUT time steps using its fourth element as a counter.
