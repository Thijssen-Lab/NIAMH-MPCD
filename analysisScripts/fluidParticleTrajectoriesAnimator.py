...
parser.add_argument('-s',"--start", type=int, help="Starting timestep for averaging",default=0)
parser.add_argument('-f',"--finish", type=int, help="Finishing timestep for averaging",default=999999999)
